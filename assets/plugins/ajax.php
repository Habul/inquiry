...
$(document).ready(function() {
   ...
   $("div.datesearchbox").html(
      '<div class="input-group col-sm-7"> <div class="input-group-prepend"><span class="input-group-text"><i class="far fa-calendar-alt"></i></span></div><input type="text" class="form-control form-control-sm pull-right" id="datesearch" placeholder="Filter by date range.."> </div > '
      );
