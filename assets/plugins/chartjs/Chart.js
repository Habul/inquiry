	...
	Chart.Scale = Chart.Element.extend({
		...
		calculateXLabelRotation: function () {
			...
			this.xScalePaddingLeft =
				firstWidth / 2 > this.yLabelWidth ? firstWidth / 2 : this.yLabelWidth;
						...
						function (dataPoint, index) {
							...
							datasetObject.bars.push(
								new this.BarClass({
									...
									strokeColor:
										typeof dataset.strokeColor == "object"
											? dataset.strokeColor[index]
											: dataset.strokeColor,
									fillColor:
										typeof dataset.fillColor == "object"
											? dataset.fillColor[index]
											: dataset.fillColor,
									highlightFill: dataset.highlightFill
										? typeof dataset.highlightFill == "object"
									...
									highlightStroke: dataset.highlightStroke
										? typeof dataset.highlightStroke == "object"
