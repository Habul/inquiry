...
class M_side2 extends CI_Model
{
    public $table = 'master_item';
    public $column_order = array(null, 'user', 'merk', 'kelompok', 'part_number', 'nama', 'satuan', 'type'); //set column field database for datatable orderable
