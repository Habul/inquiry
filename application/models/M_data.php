...
class M_data extends CI_Model
{
    ...
    public function get_index_wheredesc($condition, $where, $table)
    {
    ...
    public function insert_where($data, $table)
    {
        $this->db->insert($table, $data);
    }
    ...
    public function update_multi($where, $where2, $where3, $data, $table)
    {
        $this->db->where($where);
