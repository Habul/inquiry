                ...
                foreach ($truck as $p) { ?>
                    ...
                    ?>
									...
									<td>
										...
										<a href="<?php echo base_url() . 'driver/truck_odo/?id=' . $encrypturl; ?>" class="btn btn-primary"
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<form onsubmit="addbtn.disabled = true; return true;" method="post"
				action="<?php echo base_url('driver/truck_add') ?>" enctype="multipart/form-data">
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<form class="form-horizontal" onsubmit="editbtn.disabled = true; return true;" method="post"
				action="<?php echo base_url('driver/truck_edit') ?>" enctype="multipart/form-data">
				<div class="modal-body">
					<div class="form-group">
						<label class="control-label col-xs-3">Type</label>
						<div class="col-xs-9">
	...
	<div class="modal-dialog">
		<div class="modal-content bg-danger">
			...
			<form class="form-horizontal" onsubmit="delbtn.disabled = true; return true;" method="post"
				action="<?php echo base_url('driver/truck_del') ?>">
				<div class="modal-body">
