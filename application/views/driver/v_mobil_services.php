<div class="content-wrapper">
	<div class="content-header">
		<div class="container-fluid">
			<div class="row mb-2">
				<div class="col-sm-6">
					<h1 class="m-0">History Service</h1>					
				</div>
				<div class="col-sm-6">
                <?php foreach ($odo as $u) : ?>
					<ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="<?php echo base_url('driver/mobil_odo/'.$u->no_id) ?>">Detail</a></li>
...
<div class="modal fade" id="modal_add" tabindex="-1" data-backdrop="static">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<form class="form-horizontal" id="addform" method="post" action="<?php echo base_url('driver/mobil_history_add') ?>">
