<div class="content-wrapper">
	<div class="content-header">
		<div class="container-fluid">
			<div class="row mb-2">
				<div class="col-sm-6">
					<h1 class="m-0">Jenis Motor</h1>
					<small><b>Jika Kolom Sisa Km = 0, Maka Oli Mesin harus di ganti</b><br />
						max pemakian sesudah ganti oli motor = 1.500 Km</small>
				</div><!-- /.col -->
				<div class="col-sm-6">
								...
								foreach ($motor as $p) { ?>
									<tr style="text-align:center">
										...
										<td>
											...
											<a href="<?php echo base_url() . 'driver/motor_odo/' . $p->no_id; ?>" class="btn btn-primary btn-sm" title="View Detail"> <i class="fa fa-search"></i> </a>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<h4 class="col-12 modal-title text-center">Add data motor
					<button type="button" class="close" data-dismiss="modal" aria-label="Close">
						<span aria-hidden="true">&times;</span>
					</button>
				</h4>
			</div>
			<form class="form-horizontal" id="addform" method="post" action="<?php echo base_url('driver/motor_add') ?>" enctype="multipart/form-data">
				<div class="modal-body">
					...
					<div class="form-group">
						<label class="control-label col-xs-3">Foto motor</label>
						<div class="col-xs-9">
