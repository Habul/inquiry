							...
							<h4 class="card-title">
								...
								<div class="btn-group shadow">
									...
									<div class="dropdown-menu" role="menu">
										...
										<a class="dropdown-item" href="<?php echo base_url() . 'sj/sj_print_df/?p=' . $encrypturl; ?>"
											rel="noopener" target="_blank" title="Print Dutaflow"><i class="fas fa-print"></i> Dutaflow</a>
										<div class="dropdown-divider"></div>
										<a class="dropdown-item" href="<?php echo base_url() . 'sj/sj_print_inti/?p=' . $encrypturl; ?>"
											rel="noopener" target="_blank" title="Print Intisera"><i class="fas fa-print"></i> Intisera</a>
									</div>
								</div>
							</h4>
