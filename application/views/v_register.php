  ...
  <div class="login-box">
    <div class="card card-info card-outline">
      <div class="card-body">
        ...
        <form onsubmit="regbtn.disabled = true; return true;" action="<?php echo base_url('login/register_proses') ?>" method="post">
        <div class="input-group mb-2">
          <input type="text" name="nama" class="form-control" placeholder="Full name" value="<?= set_value('nama'); ?>" required autofocus>
        ...
        <div class="input-group mb-3">
          <input type="password" id="password-field2" name="password2" class="form-control" placeholder="Retype password" required>
          <div class="input-group-append">
            <div class="input-group-text">
      ...
      <p class="d-block text-center mt-2 mb-0">Already registered? <a href="<?php echo base_url() . 'login' ?>"><u>Login</u></a></p>
      </div>
    </div>
    <br/>
    <?php
