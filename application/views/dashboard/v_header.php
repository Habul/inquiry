      ...
      <div class="sidebar">
        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar nav-child-indent nav-compact flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item">
              <a href="<?php echo base_url() . 'dashboard/iframe' ?>" <?= $this->uri->uri_string() == 'dashboard/iframe' || $this->uri->uri_string() == '' ? 'class="nav-link active"' : 'class="nav-link"' ?>>
            ...
            <?php if ($this->session->userdata('level') == "admin") { ?>
              ...
              <li <?= $this->uri->uri_string() == 'sj/sj' ||
                ...
                <ul class="nav nav-treeview">
                  <li class="nav-item">
                    <a href="<?php echo base_url() . 'sj/sj' ?>" <?= $this->uri->uri_string() == 'sj/sj' || $this->uri->segment(2) == 'sj_view' || $this->uri->uri_string() == '' ? 'class="nav-link active"' : 'class="nav-link"' ?>>
                      <i class="far fa-circle nav-icon"></i>
                      <p>SJ Hs</p>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="<?php echo base_url() . 'sj/sj_df' ?>" <?= $this->uri->uri_string() == 'sj/sj_df' || $this->uri->segment(2) == 'sj_view_df' || $this->uri->uri_string() == '' ? 'class="nav-link active"' : 'class="nav-link"' ?>>
                      <i class="far fa-circle nav-icon"></i>
                      <p>SJ Df</p>
                    </a>
                  </li>
