			...
			<div class="row">
                ...
                $user = $this->db->query("select * from pengguna where pengguna_id='$id_user'")->row(); ?>
								<img class="profile-user-img img-fluid img-circle"
									src="<?php echo base_url() . 'gambar/profile/' . $user->foto; ?>" alt="User profile picture">
							</div>
					...
					<div class="card card-success card-outline card-outline-tabs">
							...
							<ul class="nav nav-tabs" role="tablist">
								...
								<li class="nav-item">
									<a class="nav-link" id="set_pass" data-toggle="pill" href="#pass-setting" role="tab"
										aria-controls="pass-setting" aria-selected="false">Password</a>
								</li>
							</ul>
						</div>
						...
						<div class="card-body">
							<div class="tab-content">
								<div class="tab-pane fade show active" id="profile-settiing" role="tabpanel"
									aria-labelledby="profile-settiing-tab">
									<?php foreach ($profil as $p) { ?>
									<form class="form-horizontal" onsubmit="profil.disabled = true; return true;" method="post"
										action="<?php echo base_url('dashboard/profil_update') ?>" enctype="multipart/form-data">
										<div class="form-group row">
											<label for="inputName" class="col-sm-2 col-form-label">Nama *</label>
											<div class="col-sm-10">
												<input type="text" name="nama" id="inputName" class="form-control"
													placeholder="Masukkan nama .." value="<?php echo $p->pengguna_nama; ?>" required>
								...
								<div class="tab-pane fade" id="pass-setting" role="tabpanel" aria-labelledby="pass-setting-tab">
									<form method="post" onsubmit="pass.disabled = true; return true;"
										action="<?php echo base_url('dashboard/ganti_password_aksi') ?>">
