			...
			<div class="row">
                ...
                ?>
								<tr>
									...
									<td><?php if ($p->status == 'on progress') : ?>
										<span class="badge badge-warning"><?php echo strtoupper($p->status) ?></span>
										<?php elseif ($p->status == 'reject') : ?>
										<span class="badge badge-danger"><?php echo strtoupper($p->status) ?></span>
										<?php elseif ($p->status == 'finish') : ?>
										<span class="badge badge-success"><?php echo strtoupper($p->status) ?></span>
										<?php else : ?>
										<span class="badge badge-default"><?php echo strtoupper($p->status) ?></span>
										<?php endif; ?>
									</td>
									<?php if ($this->session->userdata('level') != "purchase") { ?>
									<td style="text-align:center">
										...
										<a class="btn-sm btn-warning" data-toggle="modal"
											data-target="#modal_editsales<?php echo $p->id_buffer; ?>" title="Edit"><i
												class="fa fa-pencil-alt"></i></a>
										<?php }  ?>
										<?php if ($this->session->userdata('level') != "sales") { ?>
										<a class="btn-sm btn-primary" data-toggle="modal"
											data-target="#modal_edit_wh<?php echo $p->id_buffer; ?>"><i class="fa fa-edit"
												title="Update"></i></a>
										<a class="btn-sm btn-danger" data-toggle="modal"
											data-target="#modal_hapus<?php echo $p->id_buffer; ?>"><i class="fa fa-trash"
												title="Delete"></i></a>
									</td>
								</tr>
								<?php }  ?>
			...
			<form class="form-horizontal" id="addform" method="post" action="<?php echo base_url('buffer/buffer_aksi') ?>">
				<div class="modal-body">
					<div class="form-group row">
						...
						<div class="col-sm-10">
							<input type="hidden" name="id_buffer" readonly class="form-control"
								value="<?php echo $id_add->id_buffer + 1; ?>">
					...
					<div class="form-group row">
						...
						<div class="col-sm-10">
							<input type="datetime" name="tanggal" readonly class="form-control"
...
<div class="modal fade" id="modal_editsales<?php echo $p->id_buffer; ?>" tabindex="-1" data-backdrop="static">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<form class="form-horizontal" onsubmit="editform.disabled = true; return true;" method="post"
				action="<?php echo base_url('buffer/buffer_edit') ?>">
				<div class="modal-body">
					<div class="form-group row">
...
<div class="modal fade" id="modal_edit_wh<?php echo $p->id_buffer; ?>" tabindex="-1" data-backdrop="static">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<form class="form-horizontal" onsubmit="editwhform.disabled = true; return true;" method="post"
				action="<?php echo base_url('buffer/buffer_update') ?>">
				<div class="modal-body">
					<div class="form-group row">
						<label class="col-sm-2 col-form-label">Id Buffer</label>
						<div class="col-sm-10">
					...
					<div class="form-group row">
						...
						<div class="col-sm-10">
							<input type="text" name="wh" readonly class="form-control"
								value="<?php echo  $this->session->userdata('nama'); ?> ">
					...
					<div class="form-group row">
						...
						<div class="col-sm-10">
							<input type="datetime" name="fu" readonly class="form-control"
								value="<?php echo mdate("%Y-%m-%d %H:%i:%s"); ?>">
					...
					<div class="form-group row">
						...
						<div class="col-sm-10">
							<input type="text" name="pr_no" class="form-control" placeholder="Input No PR.."
								value="<?php echo $p->pr_no; ?>" required>
					...
					<div class="form-group row">
						...
						<div class="col-sm-10">
							<textarea name="ket_wh" class="form-control"
								placeholder="Input Ket.."><?php echo $p->ket_wh; ?></textarea>
	...
	<div class="modal-dialog">
		<div class="modal-content bg-danger">
			...
			<form class="form-horizontal" onsubmit="delform.disabled = true; return true;" method="post"
				action="<?php echo base_url('buffer/buffer_hapus') ?>">
				<div class="modal-body">
