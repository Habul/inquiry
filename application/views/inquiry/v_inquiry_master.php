				...
				<div class="col-md-12">
					<div class="card card-success card-outline">
						<div class="card-header">
							<h4 class="card-title">
								<a class="btn btn-success shadow" data-toggle="modal" data-target="#modal_add_master"><i class="fa fa-plus"></i> Add Master</a>
								<a class="btn btn-default shadow" data-toggle="modal" data-target="#modal_import_master"><i class="fas fa-file-import"></i> Import</a>
								<a href="<?php echo base_url('inquiry/inquiry_master_export'); ?>" class="btn btn-default shadow"><i class="fas fa-file-export"></i> Export</a>
							</h4>
