						...
						<div class="card-header">
							<div class="btn-group">
								<div class="col-sm-6 col-6" style="padding: 0;">
									<a class="form-control btn btn-success shadow" data-toggle="modal" data-target="#modal_add_master"><i
											class="fa fa-plus-square"></i>&nbsp; Add Master</a>
								</div>
								<div class="col-sm-6 col-4" style="padding: 0;">
									<a class="form-control btn btn-default shadow" data-toggle="modal"
										data-target="#modal_import_master"><i class="fa fa-upload"></i>&nbsp; Import</a>
								</div>
								<div class="col-sm-6 col-4" style="padding: 0;">
									<a href="<?php echo base_url('inquiry/inquiry_master_export'); ?>"
								...
								<tr>
									...
									<td style="text-align:center">
										<a class="btn-sm btn-warning" data-toggle="modal"
											data-target="#modal_edit<?php echo $p->id_master; ?>" title="Edit"><i class="fa fa-edit"></i></a>
										<a class="btn-sm btn-danger" data-toggle="modal"
											data-target="#modal_hapus<?php echo $p->id_master; ?>" title="Delete"><i
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<form class="form-horizontal" onsubmit="addform.disabled = true; return true;" method="post"
				action="<?php echo base_url('inquiry/inquiry_master_aksi') ?>">
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<form class="form-horizontal" onsubmit="editform.disabled = true; return true;" method="post"
				action="<?php echo base_url('inquiry/inquiry_master_update') ?>">
				<div class="modal-body">
					<div class="form-group">
						<label class="control-label col-xs-3">Brand Produk</label>
						<div class="col-xs-9">
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<form method="post" onsubmit="importform.disabled = true; return true;"
				action="<?php echo base_url('inquiry/inquiry_master_import') ?>" enctype="multipart/form-data">
				<div class="modal-body">
	...
	<div class="modal-dialog">
		<div class="modal-content bg-danger">
			...
			<form class="form-horizontal" onsubmit="delform.disabled = true; return true;" method="post"
				action="<?php echo base_url('inquiry/inquiry_master_hapus') ?>">
				<div class="modal-body">
