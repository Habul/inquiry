				...
				<div class="col-md-6">
					<div class="card card-primary">
						...
						<div class="card-body">
							...
							<form onsubmit="updbtn.disabled = true; return true;" method="post"
								action="<?php echo base_url('inquiry/inquiry_update') ?>">
								...
								<div class="form-group row">
									...
									<div class="col-sm-10">
										<input type="text" name="name_purch" readonly class="form-control"
                      ...
                      $format = "%Y-%m-%d %H:%i:%s";
                      ?>
										<input type="datetime" name="fu1" readonly class="form-control"
											value="<?php echo mdate($format); ?>">
								...
								<div class="form-group row">
									...
									<div class="col-sm-10">
										<select class="form-control" id="kurs" name="kurs" onchange="myKurs()" required>
											...
											<option value="<?php echo $row->id_kurs; ?>"><?php echo $row->currency; ?> - Rp
								...
								<div class="form-group row">
									...
									<div class="col-sm-10">
										...
										<input type="number" id="cogs" min="0.001" step="0.001" name="cogs" class="form-control"
											onchange="changeTipe();" placeholder="Isi Cogs.." required>
								...
								<div class="form-group row">
									...
									<div class="col-sm-10">
										<input type="number" id="cogs_idr" name="cogs_idr" class="form-control" placeholder="Isi Cogs IDR.."
											required>
								...
								<div class="form-group row">
									...
									<div class="col-sm-10">
										<input type="number" id="reseller" name="reseller" class="form-control"
											placeholder="Isi Rp Reseller.." required>
								...
								<div class="form-group row">
									...
									<div class="col-sm-10">
										<input type="number" id="new_seller" name="new_seller" class="form-control"
											placeholder="Isi Rp New Seller.." required>
								...
								<div class="form-group row">
									...
									<div class="col-sm-10">
										<input type="number" id="user " name="user" class="form-control" placeholder="Isi Rp User.."
											required>
								...
								<div class="form-group">
									<a href="<?php echo base_url('inquiry/inquiry') ?>" class="btn btn-default"><i
											class="fa fa-share"></i> Back</a>
