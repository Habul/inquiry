						...
						<div class="card-header">
							<div class="btn-group">
								<div class="col-sm-6 col-6" style="padding: 0;">
									<a class="form-control btn btn-success shadow" data-toggle="modal" data-target="#modal_add_kurs"><i
											class="fa fa-plus-square"></i>&nbsp; Add Kurs</a>
								</div>
								<div class="col-sm-6 col-4" style="padding: 0;">
									<a class=" form-control btn btn-default shadow" data-toggle="modal"
										data-target="#modal_import_kurs"><i class="fa fa-upload"></i>&nbsp; Import</a>
								</div>
								<div class="col-sm-6 col-4" style="padding: 0;">
									<a href=" <?php echo base_url('inquiry/inquiry_kurs_export'); ?>"
										class="form-control btn btn-default shadow"><i class="fa fa-download"></i> Export</a>
								</div>
							</div>
								...
								<tr>
									...
									<td style="text-align:center">
										<a class="btn-sm btn-warning" data-toggle="modal"
											data-target="#modal_edit<?php echo $p->id_kurs; ?>" title="Edit"><i class="fa fa-edit"></i></a>
										<a class="btn-sm btn-danger" data-toggle="modal"
											data-target="#modal_hapus<?php echo $p->id_kurs; ?>" title="Delete"><i
...
<div class="modal fade" id="modal_add_kurs" tabindex="-1" data-backdrop="static">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<form onsubmit="addform.disabled = true; return true;" method="post"
				action="<?php echo base_url('inquiry/inquiry_kurs_aksi') ?>">
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<form class="form-horizontal" onsubmit="editform.disabled = true; return true;" method="post"
				action="<?php echo base_url('inquiry/inquiry_kurs_update') ?>">
				<div class="modal-body">
					<div class="form-group">
...
<div class="modal fade" id="modal_import_kurs" tabindex="-1" data-backdrop="static">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<form method="post" onsubmit="importform.disabled = true; return true;"
				action="<?php echo base_url('inquiry/inquiry_kurs_import') ?>" enctype="multipart/form-data">
				<div class="modal-body">
	...
	<div class="modal-dialog">
		<div class="modal-content bg-danger">
			...
			<form class="form-horizontal" onsubmit="delform.disabled = true; return true;" method="post"
				action="<?php echo base_url('inquiry/inquiry_kurs_hapus') ?>">
				<div class="modal-body">
