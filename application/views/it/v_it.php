			...
			<form onsubmit="addbtn.disabled = true; return true;" method="post"
				...
				<div class="modal-body">
					<div class="form-group">
						...
						<div class="col-xs-9">
							<input type="hidden" name="no_id" readonly class="form-control"
								value="<?php echo $id_add->no_id + 1; ?> ">
							<input type="text" name="judul" class="form-control form-control-sm form-control-border"
